...
#Given that we specified users as having at least 100 ratings, we'll allow for 75
set.seed(42)
scheme = evaluationScheme(ratingMatrix,method = "split",
                           train=0.9, given=75, goodRating=4)
...
itemFrequencyPlot(book_trans,support=.08)
itemFrequencyPlot(book_trans,topN=5)
```
