...
```{r}
#No missing values found within either dataset
...
#rows/columns labels are sorted according to userId & movieId (but always double check)
...
med_num_ratings = median(count_ratings)
